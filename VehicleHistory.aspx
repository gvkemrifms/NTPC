...
<asp:AccordionPane ID="AccordionPane4" runat="server" Height="300px">
    ...
    <Content>
        <asp:GridView ID="gvVehicleInsurance" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" CssClass="gridviewStyle" EmptyDataText="No Records Found" ForeColor="#333333" GridLines="Both" Width="630px">
...
<asp:AccordionPane ID="AccordionPane5" runat="server" Height="300px">
    ...
    <Content>
        <table cellpadding="2" cellspacing="2" width="600px">
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvRoadTax" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" CssClass="gridviewStyle" EmptyDataText="No Records Found" ForeColor="#333333" GridLines="Both" Width="630px">
                        <RowStyle CssClass="rowStyleGrid"/>
                        <Columns>
                            <asp:TemplateField HeaderText="Vehicle Number">
                                <ItemTemplate>
...
<asp:AccordionPane ID="AccordionPane6" runat="server" BorderColor="Red" ForeColor="Red">
    ...
    <Content>
        <asp:GridView ID="gvPollutionUnderControl" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" CssClass="gridviewStyle" EmptyDataText="No Records Found" ForeColor="#333333" GridLines="Both" Width="630px">
            <RowStyle CssClass="rowStyleGrid"/>
            <Columns>
                <asp:TemplateField HeaderText="Vehicle Number">
                    <ItemTemplate>
        ...
        <asp:Accordion ID="Accordion4" runat="server" AutoSize="none" ContentCssClass="accordionContent" FadeTransitions="true" HeaderCssClass="accordionHeader" TransitionDuration="50" Width="650px">
            <Panes>
                <asp:AccordionPane ID="AccordionPane12" runat="server" BorderColor="Red" ForeColor="Red">
                    ...
                    <Content>
                        <asp:GridView ID="grdPetroCard" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" CssClass="gridviewStyle" EmptyDataText="No Records Found" ForeColor="#333333" GridLines="Both" OnPageIndexChanging="grdPetroCard_PageIndexChanging" Width="630px">
                            <RowStyle CssClass="rowStyleGrid"/>
                            <Columns>
                ...
                <asp:AccordionPane ID="AccordionPane13" runat="server" BorderColor="Red" ForeColor="Red">
                    ...
                    <Content>
                        <asp:GridView ID="grdFuelEntry" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" CssClass="gridviewStyle" EmptyDataText="No Records Found" ForeColor="#333333" GridLines="Both" Width="630px">
                            <RowStyle CssClass="rowStyleGrid"/>
                            <Columns>
