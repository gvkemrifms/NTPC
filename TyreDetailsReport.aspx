...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="center">
        <asp:Panel ID="Panel2" runat="server" HorizontalAlign="Center">
            <asp:GridView ID="Grdtyre" runat="server" BorderColor="#CCCCCC" HorizontalAlign="Center" BorderWidth="1px" EmptyDataText="No Records Found" BackColor="White" width="700px" BorderStyle="None" CellPadding="3">
