    ...
    private bool ValidateLabourGrid()
    {
        if (pnlLabourBillDetails.Visible)
            for (var i = 0; i < grdvwLabourBillDetails.Rows.Count; i++)
            {
                ...
                if (txtbxlabourdate != null && Convert.ToDateTime(Convert.ToDateTime(txtbxlabourdate.Text).ToString("MM/dd/yyyy")) > Convert.ToDateTime(DateTime.Now.ToString("MM/dd/yyyy")))
                {
