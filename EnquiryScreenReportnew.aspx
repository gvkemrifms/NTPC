...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div align="center">
        <asp:Panel ID="Panel2" HorizontalAlign="Center" runat="server">
            <asp:GridView ID="Grddetails" HorizontalAlign="Center" EmptyDataText="No Records Found" runat="server" BorderWidth="1px" BorderColor="#CCCCCC" BackColor="White" BorderStyle="None" CellPadding="3">
